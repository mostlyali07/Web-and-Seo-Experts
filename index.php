...
<body>
    ...
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="tabb d-flex desk-tab">
                ...
                <button class="tablinkss" onclick="openPricing(event, 'Pro-Marketing')">Pro Marketing Plans</button>
                <button class="tablinkss" onclick="openPricing(event, 'Website-Design')">Website Design and Development</button>
            </div>
        </div>
    </div>
    <div class="Ninth-div">
        <div class="container">
            <div class="row my-5 tabcontentt" id="Search-Engine">
                <div class="col-md-4">
                    <div class="price-box">
                        <h4>Good</h4>
    ...
    <div class="container pb-5">
        <div class="row pb-5">
            <div class="col-md-12 d-flex justify-content-evenly text-center flex-wrap">
                <div>
                    <img src="./Assets/images/guarantee.png" alt="">
                    <h6 class="m-2">100% Satisfaction <br />
                        Guarantee</h6>
                </div>
                <div>
                    <img src="./Assets/images/art-and-design.png" alt="">
                    <h6 class="m-2">100% Satisfaction <br />
                        Guarantee</h6>
                </div>
                <div>
                ...
                <div>
                    <img src="./Assets/images/24-hours-phone-service.png" alt="">
                    <h6 class="m-2">100% Satisfaction <br />
                        Guarantee</h6>
                </div>
                <div>
